...
import edu.craptocraft.sneakerrafflepostexambugfixing.raffle.Sneaker;

import edu.craptocraft.sneakerrafflepostexambugfixing.raffle.Sizes;
import edu.craptocraft.sneakerrafflepostexambugfixing.GUI.GUI;
import edu.craptocraft.sneakerrafflepostexambugfixing.raffle.Entry;

import edu.craptocraft.sneakerrafflepostexambugfixing.Payment.Payment;

import edu.craptocraft.sneakerrafflepostexambugfixing.Payment.Paypal;
...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("\t\t" + winner.getPayment() + " credit: " +
                paypal.credit(winner.getPayment()));
    }
}
